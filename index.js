...
const BotName = 'diegin2k of hype  bot'; 
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:diegin2k of hype \n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=5511998346168:+55 47992091566\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
					wait: '❬❗❭ espera um pouco manin',
					success: '️❬ ✔ ❭ ae mn, pronto',
				...
				only: {
					...
					premium: '[❗] ESTE PEDIDO É SO PARA *USUÁRIOS PREMIUMS É VOCE NAO É UM, PNC*',
					...
					ownerG: '[❗] diegin2k of hype ? Este é um recurso especial para o diegin2k of hype  ❌',
					ownerB: '[❗] diegin2k of hype ? Este é um recurso especial para o diegin2k of hype  ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de diegin2k of hype . Registre-se para fazer amizade com o bot diegin2k of hype  por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar diegin2k of hype |17\n\n──「 diegin2k of hype  BOT 」──`,
	...
	if (messagesC.includes("fdp")){
		...
		if (messagesC.includes("bot")){
            ...
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
				...
				if (messagesC.includes("diegin2k of hype ")){
			client.updatePresence(from, Presence.composing)
			tujuh = fs.readFileSync('./assets/diegin2k of hype f.mp3');
            client.sendMessage(from, tujuh, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
	}
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS diegin2k of hype  BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @diegin2k of hype  domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o diegin2k of hype  ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *ADMINBOT diegin2k of hype  ✨* 」\n*│+ wa.me/5547992091566*╰──────*「 *diegin2k of hype * 」*────*\n\n*_SE QUER SER ADMIN DO BOT diegin2k of hype _*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do diegin2k of hype :*\n\n https://youtube.com/channel/UCpB3qh2Sp3K23s9a2Q-Gf-g'})
					break
				case 'nsfwloli1':
					memein = await kagApi.memeindo()
